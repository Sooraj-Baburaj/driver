...
const Delivered = (props) => {
    ...
    fetch(USER_BASE_API + "/get-orders", {
      ...
      .then((data) => {
        const newData = data.Data.map(
          ({ LRTL_timestamp, ResultCount, ...rest }) => rest
        );
  ...
  return (
    <>
      ...
      <section style={{ marginLeft: "70px" }} class="main_contents">
                ...
                {tableData?.map((item, index) => (
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      {" "}
                      <Link
                        to={`/dashboard/delivered/details/${item.LRTL_orderlrnumber}`}
                        class="btn btn_comm"
                      >
                        {" "}
                        Details
      ...
      <Modal
        show={show}
        onHide={handleClose}
        dialogClassName="modal-dialog modal-xl clsmodal1"
      >
            ...
            <ul class="d-lg-flex track_dtls_input_row">
              <li>
                <div class="form-group">
                  ...
                  <input
                    type="text"
                    value={tableDataTracking[0]?.ConsgneM_name}
                    class="form-control"
                    placeholder=""
                  />
                </div>
              ...
              <li>
                <div class="form-group">
                  ...
                  <input
                    type="text"
                    value={tableDataTracking[0]?.LRTL_orderlrnumber}
                    class="form-control"
                    placeholder=""
                  />
                </div>
